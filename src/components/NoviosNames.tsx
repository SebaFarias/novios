...
const NoviosName: React.FunctionComponent<NoviosNameProps> = props => {
    return (
        <article className="flex flex-col items-center relative ">
            ...
            <h1 className="text-6xl animate-[appear_2s_ease-out_forwards] md:text-8xl text-pink-600 font-manus z-10 opacity-0">Andrea</h1>
            <h1 className="font-serif animate-[appear_2s_ease-out_1s_forwards] text-pink-600 z-10 opacity-0">Díaz Ubilla</h1>
            <h1 className="text-6xl animate-[appear_2s_ease-out_forwards] md:text-8xl text-pink-600 font-manus z-10 mt-10 opacity-0">Felipe</h1>
