...
const RegalosShower : FunctionComponent<RegalosShowerProps> = ({regalos = REGALOS}) => {
  ...
  <section className='min-h-[70vh] flex flex-col justify-around items-center' id="regalos">
    <h2 className="text-2xl md:text-4xl mb-6 text-center px-4 text-amber-950 font-serif opacity-60">Si quieres hacer uno adicional puedes escoger de esta lista:</h2>
