...
import SelectedCardShower from "@/components/SelectedCardShower";
...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-around px-2">
      ...
      <Cuenta/>
      <Link href="/" className="font-serif border-2 border-[#D5B699]  py-2 px-6 rounded text-[#9D8373] hover:text-[#8A6C5C] bg-transparent hover:bg-[#F0D7C1]  transition-all " >
        VOLVER
      </Link>
    </main>
  )
